...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Core.Entities.AssigneeTable", b =>
                {
            ...
            modelBuilder.Entity("API.Core.Entities.Bonus", b =>
                {
            ...
            modelBuilder.Entity("API.Core.Entities.CompanyDetails", b =>
                {
            ...
            modelBuilder.Entity("API.Core.Entities.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Core.Entities.EmployeeBiodata", b =>
                {
            ...
            modelBuilder.Entity("API.Core.Entities.EmploymentType", b =>
                {
            ...
            modelBuilder.Entity("API.Core.Entities.JobDescription", b =>
                {
                    b.Property<int>("JobDescriptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Core.Entities.LeaveType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Core.Entities.PayrollAdditionItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Core.Entities.PayrollAdditionItemsAssignment", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("API.Core.Entities.PayrollCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Core.Entities.PayrollDeductionItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Core.Entities.PayrollDeductionItemsAssignment", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("API.Core.Entities.PayrollDefault", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Core.Entities.PayrollOvertimeItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Core.Entities.PayrollOvertimeItemsAssignment", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("API.Core.Entities.PayrollRate", b =>
                {
                    b.Property<int>("RateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Core.Entities.PayrollTransaction", b =>
                {
            ...
            modelBuilder.Entity("API.Core.Entities.Payslip", b =>
                {
            ...
            modelBuilder.Entity("API.Core.Entities.PensionFundAdministration", b =>
                {
            ...
            modelBuilder.Entity("API.Core.Entities.Request", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Core.Entities.StatutoryDeduction", b =>
                {
            ...
            modelBuilder.Entity("API.Core.Entities.Tax", b =>
                {
            ...
            modelBuilder.Entity("API.Core.Entities.TimeSheet", b =>
                {
            ...
            modelBuilder.Entity("API.Core.Entities.Bonus", b =>
                {
                    b.HasOne("API.Core.Entities.Department", "Department")
                        .WithMany()
                        .HasForeignKey("DepartmentId")
                        .HasConstraintName("FK__Bonuses__departm__2B3F6F97")
                        .IsRequired();

                    b.HasOne("API.Core.Entities.JobDescription", "JobDescription")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Core.Entities.PayrollAdditionItem", b =>
                {
                    b.HasOne("API.Core.Entities.AssigneeTable", "Assignee")
                        .WithMany("PayrollAdditionItems")
                        .HasForeignKey("AssigneeId")
                        .HasConstraintName("FK_PayrollAdditionItems_AssigneeTable")
                        .IsRequired();

                    b.HasOne("API.Core.Entities.PayrollCategory", "Category")
                        .WithMany("PayrollAdditionItems")
            ...
            modelBuilder.Entity("API.Core.Entities.PayrollDeductionItemsAssignment", b =>
                {
                    ...
                    b.HasOne("API.Core.Entities.PayrollDeductionItem", "PayrollItem")
                        .WithMany("PayrollDeductionItemsAssignments")
                        .HasForeignKey("PayrollItemId")
            ...
            modelBuilder.Entity("API.Core.Entities.PayrollOvertimeItem", b =>
                {
                    b.HasOne("API.Core.Entities.PayrollRate", "Rate")
            ...
            modelBuilder.Entity("API.Core.Entities.PayrollOvertimeItemsAssignment", b =>
                {
                    ...
                    b.HasOne("API.Core.Entities.PayrollOvertimeItem", "PayrollItem")
                        .WithMany("PayrollOvertimeItemsAssignments")
                        .HasForeignKey("PayrollItemId")
            ...
            modelBuilder.Entity("API.Core.Entities.StatutoryDeduction", b =>
                {
                    ...
                    b.HasOne("API.Core.Entities.PensionFundAdministration", "PfaCodeNavigation")
                        .WithMany("StatutoryDeductions")
            ...
            modelBuilder.Entity("API.Core.Entities.Tax", b =>
                {
                    b.HasOne("API.Core.Entities.EmployeeBiodata", "Employee")
                        .WithOne("Tax")
                        .HasForeignKey("API.Core.Entities.Tax", "EmployeeId")
